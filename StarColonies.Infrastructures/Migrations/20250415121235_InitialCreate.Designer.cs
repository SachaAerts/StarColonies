...
namespace StarColonies.Infrastructures.Migrations
{
    ...
    [Migration("20250415121235_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StarColonies.Infrastructures.Data.Entities.EnemyEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StarColonies.Infrastructures.Data.Entities.MissionEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StarColonies.Infrastructures.Data.Entities.PlanetEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EnemyEntityMissionEntity", b =>
                {
                    b.HasOne("StarColonies.Infrastructures.Data.Entities.EnemyEntity", null)
                        .WithMany()
                        .HasForeignKey("EnemiesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StarColonies.Infrastructures.Data.Entities.MissionEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StarColonies.Infrastructures.Data.Entities.Items.RewardedEntity", b =>
                {
                    ...
                    b.HasOne("StarColonies.Infrastructures.Data.Entities.MissionEntity", "Mission")
                        .WithMany("Rewards")
            ...
            modelBuilder.Entity("StarColonies.Infrastructures.Data.Entities.MissionEntity", b =>
                {
                    b.HasOne("StarColonies.Infrastructures.Data.Entities.PlanetEntity", "Planet")
                        .WithMany("Missions")
